...
from .losses import GraphConLoss, Loss_PC
from .GCN import GCN
...
class student_sfda_RCNN(nn.Module):
    ...
    def forward(self, batched_inputs: List[Dict[str, torch.Tensor]], cfg=None, model_teacher=None, t_features=None, t_proposals=None, t_results=None, mode="test"):
        ...
        losses["graph_conloss_PS"], losses["graph_conloss_PE"] = self.loss_PC(t_box_features.mean(dim=[2, 3]), t_roih_logits, s_box_features.mean(dim=[2, 3]), s_roih_logits, self.GraphCN)
