...
class teacher_sfda_RCNN(nn.Module):
    ...
    def forward(self, batched_inputs: List[Dict[str, torch.Tensor]], mode="test", net='teacher'):
        """
        Args:
        ...
        results, detector_losses = self.roi_heads(images, features, proposals, gt_instances, net)
